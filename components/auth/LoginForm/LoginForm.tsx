    ...
    <form action="" className='flex flex-col w-full justify-center items-center gap-6'>
        ...
        <div className='flex flex-col gap-4 justify-center items-center w-3/4'>
            <div className=' flex flex-col gap-1 w-full'>
                ...
                <input type="text" placeholder='Enter your email' className='p-4 border border-gray-400 rounded-lg' required/>
            </div>
            <div className='flex flex-col gap-1 relative  w-full'>
                <label htmlFor="">Password</label>
                <input type={isVisible ? "text" : "password"} placeholder='********' className='p-4 border border-gray-400 rounded-lg  '  required/>
            ...
            <div className='flex flex-col justify-center items-center w-full gap-2'>
                <button className=' bg-[#EA454C] w-full py-3 text-white rounded-xl cursor-pointer'>Sign in</button>
        ...
        <div className='flex justify-center items-center'>
            <label htmlFor="" className='text-sm'>Don&apos;t have an account? <Link href = "/auth/registerform/" className='text-red-500 text-sm'>Sign up for free!</Link></label>   
        </div>
    </form>
            <Aside/> 
    </div>  
